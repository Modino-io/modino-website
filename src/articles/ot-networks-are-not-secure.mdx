...
summary: "OT networks face growing cyber risks as legacy systems and false assumptions leave them exposed."
date: "2025-05-14"
...
5. **“Old systems can’t be secured.”**  
   *Reality:* You can wrap older devices in modern protections — segmentation, DPI, access control, etc.  
   _Control Engineering_: [The cybersecurity challenges of legacy OT and how to manage them](https://www.controleng.com/the-cybersecurity-challenges-of-legacy-ot-and-how-to-manage-them/)
...
These aren’t just [best practices](https://modino.io/articles/importance-of-iot-cybersecurity/) — they’re legal obligations. And in many verticals (energy, healthcare, transport), compliance is now a prerequisite for doing business.
