...
- **Ransomware**: Encrypts data, demanding a ransom for its release. Studies show that it may be fatal to patients as outlined by [Wierd](https://www.wired.com/story/ransomware-hospital-death-germany/).
