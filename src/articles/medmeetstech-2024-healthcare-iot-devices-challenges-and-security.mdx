...
- **Ransomware**: Encrypts data, demanding a ransom for its release. Studies show that it may be fatal to patients as outlined by Wierd.
...
Source: https://ransomware.org/blog/healthcare-industry-vulnerable-to-ransomware/ 
...
| Regulation Name | Focus Area | Effective Date |
|:------------- |:------------ |:-------------
| ISO 81001-5-1   | Security of medical software | May 24, 2024 |
| EU Cyber Resilience Act | Medical ecosystem including cloud services, software and servers | March 12, 2024 |
| Radio Equipment Directive | Devices using wireless networks | August 1, 2024 |
| Network and Information Security Directive (NIS-2) | Updates to security standarts, including those for Medical IoT | January 16, 2023 |
